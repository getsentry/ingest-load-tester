...
def breadcrumb_generator(
    min=None, max=None, categories=None, levels=None, types=None, messages=None
):
    ...
    levels = (
        levels if levels is not None else ["fatal", "error", "warning", "info", "debug"]
    )
